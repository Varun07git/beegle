    ...
    <div class="home-content">
        <div class="container-fluid">
            <div class="row top-band">
                ...
                <div class="col-auto">
                    <span class="text">Project Dashboard</span>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <p class="card-text">
                                        <?php
                                        // select projects where deadline is passed and status is not equal to completed
                                        $sql = "SELECT * FROM projects WHERE project_end_date < NOW() AND `status` != 'finished'";
                                        $result = mysqli_query($conn, $sql);
                                        $totalProjects = mysqli_num_rows($result);
                                        echo $totalProjects;
                                        ?>
